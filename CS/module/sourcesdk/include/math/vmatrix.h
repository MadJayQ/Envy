...
namespace Envy
{
	namespace SourceEngine
	{
		...
		public:
			...
			matrix3x4_t& operator=(const matrix3x4_t& src) { memcpy(Base(), src.Base(), sizeof(float) * 3 * 4); return *this; };
			//-----------------------------------------------------------------------------
		...
		public:
			...
			*/
			matrix3x4a_t() {}
			matrix3x4a_t(const matrix3x4_t& src) { memcpy(Base(), src.Base(), sizeof(float) * 3 * 4); }
