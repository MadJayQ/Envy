...
namespace Envy
{
	namespace SourceEngine
	{
		...
		class _IGameEventManager2_
		{
		public:
			virtual             ~_IGameEventManager2_() = 0;
	...
	class IGameEventManager2 : public SourceInterface<SourceEngine::_IGameEventManager2_>
	{
	public:
		IGameEventManager2() {}
		...
		virtual Interface* Init() override
		{
			m_data = reinterpret_cast<Interface*>(
				Interfaces::Instance()->GetInterfaceAddr("GAMEEVENTSMANAGER")
			);
			SourceInterface<SourceEngine::_IGameEventManager2_>::Init();
			return m_data;
		}
	};
}