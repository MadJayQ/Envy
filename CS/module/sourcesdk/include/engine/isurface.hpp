...
namespace Envy
{
	namespace SourceEngine
	{
		...
		//-----------------------------------------------------------------------------
		class _ISurface_ : public IAppSystem
		{
		public:
	...
	class ISurface : public SourceInterface<SourceEngine::_ISurface_>
	{
	public:
		ISurface() {}
		...
		virtual Interface* Init() override
		{
			m_data = reinterpret_cast<Interface*>(
				Interfaces::Instance()->GetInterfaceAddr("VGUI_Surface")
			);

			SourceInterface<SourceEngine::_ISurface_>::Init();
