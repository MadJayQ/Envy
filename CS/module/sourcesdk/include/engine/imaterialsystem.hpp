...
namespace Envy
{
	namespace SourceEngine
	{
		...
		struct ApplicationInstantCountersInfo_t
		{
			...
			uint32_t m_nDex1ferredWordsAllocated;
		};
		...
		class _IMaterialSystem_ : public IAppSystem
		{
		public:
	...
	public:
		...
		virtual Interface* Init() override
		{
			m_data = reinterpret_cast<Interface*>(
				Interfaces::Instance()->GetInterfaceAddr("VMaterialSystem")
			);
			SourceInterface<SourceEngine::_IMaterialSystem_>::Init();
