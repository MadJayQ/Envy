...
#define MAX_AREA_PORTAL_STATE_BYTES 24
	...
	class IVRenderView : public SourceInterface<SourceEngine::_IVRenderView_>
	{
	public:
		IVRenderView() {}
		...
		virtual Interface* Init() override
		{
			m_data = reinterpret_cast<Interface*>(
				Interfaces::Instance()->GetInterfaceAddr("VEngineRenderView")
			);

			SourceInterface<SourceEngine::_IVRenderView_>::Init();
