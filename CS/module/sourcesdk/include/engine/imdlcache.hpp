...
namespace Envy
{
	namespace SourceEngine
	{
		...
		class _IMDLCache_ : public IAppSystem
		{
		public:
	...
	class IMDLCache : public SourceInterface<SourceEngine::_IMDLCache_>
	{
	public:
		IMDLCache() {}
		...
		virtual Interface* Init() override
		{
			m_data = reinterpret_cast<Interface*>(
				Interfaces::Instance()->GetInterfaceAddr("MDLCache")
			);
			SourceInterface<SourceEngine::_IMDLCache_>::Init();
			return m_data;
		}
	};
}