...
#define PITCH_HIGH		120
	...
	class IEngineSound : public SourceInterface<SourceEngine::_IEngineSound_>
	{
	public:
		IEngineSound() {}
		...
		virtual Interface* Init() override
		{
			m_data = reinterpret_cast<Interface*>(
				Interfaces::Instance()->GetInterfaceAddr("IEngineSoundClient")
			);

			SourceInterface<SourceEngine::_IEngineSound_>::Init();
