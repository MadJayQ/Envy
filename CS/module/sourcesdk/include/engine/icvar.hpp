...
namespace Envy
{
	namespace SourceEngine
	{
		...
		class _ICVar_ : public IAppSystem
		{
		public:
	...
	class ICvar : public SourceInterface<SourceEngine::_ICVar_>
	{
	public:
		ICvar() {}
		virtual Interface* Init() override
		{
			m_data = reinterpret_cast<Interface*>(
				Interfaces::Instance()->GetInterfaceAddr("VEngineCvar007")
			);
			SourceInterface<SourceEngine::_ICVar_>::Init();
			return m_data;
		}
	};
}