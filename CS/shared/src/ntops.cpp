...
constexpr const char* ApiSetResolveToHost_Signature = "48 89 58 08 48 89 70 10 48 89 78 18 4C 89 70 20 41 57 48 83 EC 20 48 8b 74 24 50 33 c0";

ULONG64 FindSignature(const char* module, const char* signature)
{
	return Helpers::Instance()->FindSignature(
		std::string(module),
